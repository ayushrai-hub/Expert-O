...
const OurStory = () => {
  return (
    <section id="story" className="py-24 bg-gradient-to-b from-black to-gray-900">
      <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="order-1 lg:order-2">
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 rounded-2xl p-8">
                <Target size={48} className="text-purple-400 mb-6" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur border border-gray-700 rounded-2xl p-8">
              <Zap size={48} className="text-cyan-400 mb-6" />
          ...
          <div>
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 rounded-2xl p-8">
                <Heart size={48} className="text-red-400 mb-6" />
